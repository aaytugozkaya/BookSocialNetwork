...
private final BookService service;
    ...
    public ResponseEntity<Integer> uploadCover(@PathVariable("book-id") Integer bookId, @Parameter() @RequestPart("file") MultipartFile file, Authentication connectedUser) {
